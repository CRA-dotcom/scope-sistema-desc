...
This project is indexed by GitNexus as **DESC** (10091 symbols, 11312 relationships, 45 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/DESC/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/DESC/context` | Codebase overview, check index freshness |
| `gitnexus://repo/DESC/clusters` | All functional areas |
| `gitnexus://repo/DESC/processes` | All execution flows |
| `gitnexus://repo/DESC/process/{name}` | Step-by-step execution trace |
