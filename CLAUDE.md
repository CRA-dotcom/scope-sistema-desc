...
This project is indexed by GitNexus as **DESC** (9205 symbols, 10183 relationships, 39 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
