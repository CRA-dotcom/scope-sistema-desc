...
This project is indexed by GitNexus as **DESC** (10095 symbols, 11324 relationships, 45 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
