...
This project is indexed by GitNexus as **DESC** (9692 symbols, 10748 relationships, 39 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
