...
This project is indexed by GitNexus as **DESC** (9127 symbols, 10016 relationships, 39 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
