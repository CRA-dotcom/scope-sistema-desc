...
This project is indexed by GitNexus as **DESC** (8638 symbols, 9377 relationships, 34 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
